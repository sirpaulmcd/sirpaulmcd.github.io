...
In terms of Data Structures and Algorithms, depending on the application, time complexity is typically the priority followed by space complexity. This is because, in mordern times, memory is relatively abundant and cheap. Computational complexity is more of a tie-breaker. 
